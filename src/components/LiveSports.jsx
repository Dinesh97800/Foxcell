    ...
    <section className="py-20 bg-white relative">
      <div className="container mx-auto px-6 grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
        ...
        <div className="relative flex">
          {/* Vertical Red Bar */}
          <div className="bg-red-600 text-white flex flex-col justify-center items-center px-6 py-16 space-y-12">
        ...
        <div>
          ...
          <div className="flex space-x-4 mt-6">
            ...
            <button className="px-4 py-2 bg-red-600 text-white font-semibold rounded relative">
              Our Strategy
          ...
          <ul className="mt-6 space-y-2">
            <li className="flex items-center gap-2 text-gray-700">
              <CheckCircle className="w-5 h-5 text-red-600" /> 100 Mbps YouTube
            </li>
            <li className="flex items-center gap-2 text-gray-700">
              <CheckCircle className="w-5 h-5 text-red-600" /> Connect Multiple
              Users
            </li>
          </ul>
          ...
          <div className="mt-8">
            ...
            <p className="text-right text-sm font-bold text-red-600">75%</p>
          </div>
        </div>
      </div>
    </section>
