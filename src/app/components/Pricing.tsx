...
export default function PricingPlans() {
  return (
    <section id='pricing' className="py-20 bg-[#0b0b18]">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 mt-12">
          {plans.map((plan, idx) => (
            ...
            >
              {/* Popular Ribbon */}
              {plan.popular && (
                <div className="absolute top-0 right-0 bg-[#fe8900] text-white text-xs px-3 py-1 font-semibold">
                  Popular
                </div>
              )}
              ...
              <div className="bg-gray-100 py-6">
                <p className="text-[#fe8900] font-semibold">{plan.category}</p>
              ...
              <div className="px-6 py-6 text-left">
                ...
                {/* Button */}
                <FancyButton isFullWidth='w-full'>Get Started</FancyButton>
              </div>
            </div>
          ))}
        </div>
